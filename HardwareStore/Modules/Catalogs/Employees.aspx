<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Employees.aspx.cs" Inherits="HardwareStore.Modules.Catalogs.Employees" %>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="new-tab" data-toggle="tab" href="#new-content" role="tab" aria-controls="new-content" aria-selected="false">Nuevo Empleado</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="list-tab" data-toggle="tab" href="#list-content" role="tab" aria-controls="list-content" aria-selected="true">Lista de Empleados</a>
                            </li>
                        </ul>
                        <%-- End Headers of tabs --%>
                                                                                ...
                                                                                <div class="form-row">
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <div class="input-group">
                                                                                            <input runat="server" type="text" name="Type" id="txtNameEmployed" class="form-control" />
                                                                                            <asp:RequiredFieldValidator Font-Size="10" ForeColor="Red" runat="server" ID="RequiredFieldValidator1" ValidationGroup="DetailsGroup" ControlToValidate="txtNameEmployed">
                                                                                    ...
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <div class="input-group">
                                                                                            <input runat="server" type="text" name="Type" id="txtLastNameEmployed" class="form-control" />
                                                                                            <asp:RequiredFieldValidator Font-Size="10" ForeColor="Red" runat="server" ID="RequiredFieldValidator2" ValidationGroup="DetailsGroup" ControlToValidate="txtLastNameEmployed">
                                                                                                <div class="ctrlvalidate">
                                                                                                    <div style="color: #fff">
                                                                                                        Campo requerido  
                                                                                                     </div>
                                                                                    ...
                                                                                    <div class="col-lg-6">
                                                                                        <label style="float: left; margin-left: 5px;">Cargo</label>
                                                                                        <div class="input-group">
                                                                                            <input runat="server" type="text" name="Type" id="txtCargo" class="form-control" />
                                                                                            <asp:RequiredFieldValidator Font-Size="10" ForeColor="Red" runat="server" ID="RequiredFieldValidator3" ValidationGroup="DetailsGroup" ControlToValidate="txtCargo">
                                                                                                <div class="ctrlvalidate">
                                                                                                    <div style="color: #fff">
                                                                                                        Campo requerido  
                                                                                                     </div>
                                                                                    ...
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <div class="input-group">
                                                                                            <input runat="server" type="text" name="Type" id="txtDNI" class="form-control" />
                                                                                            <asp:RequiredFieldValidator Font-Size="10" ForeColor="Red" runat="server" ID="RequiredFieldValidator4" ValidationGroup="DetailsGroup" ControlToValidate="txtDNI">
                                                                                                <div class="ctrlvalidate">
                                                                                                    <div style="color: #fff">
                                                                                                        Campo requerido  
                                                                                                     </div>
                                                                                    ...
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <div class="input-group">
                                                                                            <input runat="server" type="text" name="Type" id="txtTel" class="form-control" />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
