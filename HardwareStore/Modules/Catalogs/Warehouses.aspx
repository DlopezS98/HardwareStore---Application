<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Warehouses.aspx.cs" Inherits="HardwareStore.Modules.Catalogs.Warehouses" %>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="new-tab" data-toggle="tab" href="#new-content" role="tab" aria-controls="new-content" aria-selected="false">Nueva Bodega</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="list-tab" data-toggle="tab" href="#list-content" role="tab" aria-controls="list-content" aria-selected="true">Lista de Bodegas</a>
                            </li>
                        </ul>
                        <%-- End Headers of tabs --%>
                                                                                ...
                                                                                <div class="form-row">
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <div class="input-group">
                                                                                            <input runat="server" type="text" name="Type" id="txtLastNameWarehauses" class="form-control" />
                                                                                            <asp:RequiredFieldValidator Font-Size="10" ForeColor="Red" runat="server" ID="RequiredFieldValidator2" ValidationGroup="DetailsGroup" ControlToValidate="txtLastNameWarehauses">
                                                                                    ...
                                                                                    <div class="col-lg-6">
                                                                                        <label style="float: left; margin-left: 5px;">Ubicación</label>
                                                                                        <div class="input-group">
                                                                                            <input runat="server" type="text" name="Type" id="txtUbication" class="form-control" />
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-lg-12">
                                                                    ...
                                                                    <div class="card-body table-responsive mt-3 mb-3">
                                                                        <asp:GridView runat="server" DataKeyNames="Code" AutoGenerateColumns="false"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField HeaderText="Ubicación" />
