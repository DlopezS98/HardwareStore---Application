                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="new-tab" data-toggle="tab" href="#new-content" role="tab" aria-controls="new-content" aria-selected="false">Nuevo Cliente</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="list-tab" data-toggle="tab" href="#list-content" role="tab" aria-controls="list-content" aria-selected="true">Lista de Clientes</a>
                            </li>
                        </ul>
                        <%-- End Headers of tabs --%>
                                                                                ...
                                                                                <div class="form-row">
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <div class="input-group">
                                                                                            <input runat="server" type="text" name="Type" id="txtNameCustumer" class="form-control" />
                                                                                            <asp:RequiredFieldValidator Font-Size="10" ForeColor="Red" runat="server" ID="RequiredFieldValidator2" ValidationGroup="DetailsGroup" ControlToValidate="txtNameCustumer">
                                                                                    ...
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <div class="input-group">
                                                                                            <input runat="server" type="text" name="Type" id="txtLasNameCustumer" class="form-control" />
                                                                                            <asp:RequiredFieldValidator Font-Size="10" ForeColor="Red" runat="server" ID="RequiredFieldValidator1" ValidationGroup="DetailsGroup" ControlToValidate="txtLasNameCustumer">
                                                                                                <div class="ctrlvalidate">
                                                                                                    <div style="color: #fff">
                                                                                                        Campo requerido  
                                                                                                     </div>
                                                                                    ...
                                                                                    <div class="col-lg-6">
                                                                                        <label style="float: left; margin-left: 5px;">Identificación</label>
                                                                                        <div class="input-group">
                                                                                            <input runat="server" type="text" name="Type" id="txtIdentification" class="form-control" />
                                                                                            <asp:RequiredFieldValidator Font-Size="10" ForeColor="Red" runat="server" ID="RequiredFieldValidator3" ValidationGroup="DetailsGroup" ControlToValidate="txtIdentification">
                                                                                                <div class="ctrlvalidate">
                                                                                                    <div style="color: #fff">
                                                                                                        Campo requerido  
                                                                                                     </div>
                                                                                    ...
                                                                                    <div class="col-lg-6">
                                                                                        <label style="float: left; margin-left: 5px;">Teeléfono</label>
                                                                                        <div class="input-group">
                                                                                            <input runat="server" type="text" name="Type" id="txtNumTelephone" class="form-control" />
                                                                                            <asp:RequiredFieldValidator Font-Size="10" ForeColor="Red" runat="server" ID="RequiredFieldValidator4" ValidationGroup="DetailsGroup" ControlToValidate="txtNumTelephone">
                                                                                                <div class="ctrlvalidate">
                                                                                                    <div style="color: #fff">
                                                                                                        Campo requerido  
                                                                                                     </div>
                                                                                    ...
                                                                                    <div class="col-lg-12">
                                                                                        ...
                                                                                        <div class="input-group">
                                                                                            <input runat="server" type="text" name="Type" id="txtEmail" class="form-control" />
                                                                                            <asp:RequiredFieldValidator Font-Size="10" ForeColor="Red" runat="server" ID="RequiredFieldValidator5" ValidationGroup="DetailsGroup" ControlToValidate="txtEmail">
                                                                                                <div class="ctrlvalidate">
                                                                                                    <div style="color: #fff">
                                                                                                        Campo requerido  
                                                                                                     </div>
