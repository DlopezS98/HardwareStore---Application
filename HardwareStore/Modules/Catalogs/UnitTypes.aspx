<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UnitTypes.aspx.cs" Inherits="HardwareStore.Modules.Catalogs.UnitTypes" %>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="new-tab" data-toggle="tab" href="#new-content" role="tab" aria-controls="new-content" aria-selected="false">Nuevo Tipo de Unidad</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="list-tab" data-toggle="tab" href="#list-content" role="tab" aria-controls="list-content" aria-selected="true">Lista Tpos de Unidades</a>
                            </li>
                        </ul>
                        <%-- End Headers of tabs --%>
                                                                                ...
                                                                                <div class="form-row">
                                                                                    <div class="col-lg-12">
                                                                                        ...
                                                                                        <div class="input-group">
                                                                                            <input runat="server" type="text" name="Type" id="txtNameUnitType" class="form-control" />
                                                                                            <asp:RequiredFieldValidator Font-Size="10" ForeColor="Red" runat="server" ID="RequiredFieldValidator2" ValidationGroup="DetailsGroup" ControlToValidate="txtNameUnitType">
